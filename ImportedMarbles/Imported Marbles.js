...
function renderProducts(productsToRender = products) {
  ...
  productsToRender.forEach((product) => {
    const productCard = document.createElement("div");
    productCard.className = "product-card  border p-2  rounded-lg shadow-2xl bg-green-50";
    ...
    productCard.innerHTML = `
      <img
        ...
        "
      />
      <h2 class="text-lg font-bold font-mono text-center underline ">${product.name}</h2>
      <button
